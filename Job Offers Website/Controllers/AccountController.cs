...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult EditProfile(EditProfileViewModel Profile)
        {
            ...
            var UserId = User.Identity.GetUserId();
            var crrnetuser = db.Users.Where(a => a.Id == UserId).SingleOrDefault();

            if(!UserManager.CheckPassword(crrnetuser,Profile.currentPassword))
            ...
            else
            {
                ...
                crrnetuser.UserName = Profile.Username;
                crrnetuser.Email = Profile.Email;
                crrnetuser.PasswordHash = newPasswordHash;

                db.Entry(crrnetuser).State = System.Data.Entity.EntityState.Modified;
                db.SaveChanges();
                ViewBag.message = "تمت عملية بنجاح ";
